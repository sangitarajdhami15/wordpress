...
class ctSizeGuidePlugin {
	...
	protected function loadFiles() {
		...
		require_once dirname( __FILE__ ) . '/ctSizeGuideTags.php';
	...
	public function registerAdminAssets( $hook ) {
		...
		if ( $screen && $screen->id == 'ct_size_guide' ) {
			wp_enqueue_style( 'ct_jquery_edittable', CT_SIZEGUIDE_ASSETS . 'css/jquery.edittable.min.css' );
			wp_enqueue_script( 'ct_jquery_edittable', CT_SIZEGUIDE_ASSETS . 'js/jquery.edittable.min.js', array( 'jquery' ) );
