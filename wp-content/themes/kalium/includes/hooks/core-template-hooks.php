...
/**
 * Breadcrumb in pages or archives.
 */
add_action( 'wp', '_kalium_breadcrumb' );

/**
 * Kalium's built-in image lazy loading implementation.
 */
add_action( 'init', '_kalium_image_lazy_loading' );

/**
 * Icon fonts preloading.
 */
add_action( 'wp_enqueue_scripts', '_kalium_icon_fonts_preloading', 10000 );

/**
 * Disable Gutenberg editor CSS.
 */
add_action( 'wp_enqueue_scripts', '_kalium_disable_gutenberg_styles' );

/**
 * Disable jQuery migrate.
 */
add_action( 'wp_default_scripts', '_kalium_disable_jquery_migrate' );

/**
 * Disable WordPress Emoji library.
 */
add_action( 'wp_enqueue_scripts', '_kalium_disable_wp_emoji' );

/**
 * Disable WordPress Embed library.
 */
add_action( 'wp_enqueue_scripts', '_kalium_disable_wp_embed' );

/**
 * JPEG quality.
 */
add_filter( 'jpeg_quality', '_kalium_jpeg_quality' );
